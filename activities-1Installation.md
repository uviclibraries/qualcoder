...
4.	Follow the installation prompts
 <img src="images/Windows/InstallWin5.png" alt="hierarchy chart" style="width:600px; margin-left:10px;">
5.	Once installed, launch **QualCoder**
 <img src="images/Windows/InstallWin6.png" alt="hierarchy chart" style="width:600px; margin-left:10px;">
...
1. **Set the Coder Name.** QualCoder assigns a coder name to every code you apply. This is useful for tracking who performed the coding. 
 ...
 <img src="images/Windows/SetWin1.png" alt="hierarchy chart" style="width:600px; margin-left:10px;">
    - In the **Current coder** field, click on the **Change** button (beside **Current Coder**).
 <img src="images/Windows/SetWin2.png" alt="hierarchy chart" style="width:600px; margin-left:10px;">
    - In the **Coders** dialog box:
 <img src="images/Windows/SetWin3.png" alt="hierarchy chart" style="width:600px; margin-left:10px;">
        -   Click **New**
        -   Enter your name or initial
        - 	Click **OK**
    - Select your name or initial in the Coder dialogue box and click **OK** 
 <img src="images/Windows/SetWin4.png" alt="hierarchy chart" style="width:600px; margin-left:10px;">
...
2. **Configure Language and Appearance.** You can adjust the interface to suit your preferences.
 ...
 <img src="images/Windows/SetWin5.png" alt="hierarchy chart" style="width:600px; margin-left:10px;">
