...
<img src="images/Windows/NewProjWin1.png" alt="hierarchy chart" style="width:800px; margin-left:10px;">
  - In the dialog box:
    - Enter a project name (e.g., “2019 Youth Climate March News Analysis”)
    - Choose a location on your computer to save the project
  - Click **Save**
<img src="images/Windows/NewProjWin2.png" alt="hierarchy chart" style="width:800px; margin-left:10px;">
...
2.	**Navigating the QualCoder Workspace.** Once your project is created, you will see the main QualCoder interface. The workspace is organized into a few key areas that you will use throughout your analysis.
  ...
  - This is where you: 
    ...
    - Highlight text 
    - Apply codes
<img src="images/Windows/Interface.png" alt="hierarchy chart" style="width:800px; margin-left:10px;">
...
<img src="images/Windows/AddFilesWin1.png" alt="hierarchy chart" style="width:800px; margin-left:10px;">
  - In the Manage Files tab, click the **Add File** 
<img src="images/Windows/AddFilesWin2.png" alt="hierarchy chart" style="width:800px; margin-left:10px;">
  - Navigate to the two files you downloaded 
  - Select both text files and click **Open** 
  - Click Close to return to the main workspace
<img src="images/Windows/AddFilesWin3.png" alt="hierarchy chart" style="width:800px; margin-left:10px;">
...
<img src="images/Windows/PdfWin1.png" alt="hierarchy chart" style="width:400px; margin-left:10px;">
